                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className={`p-3 rounded-2xl`}>
                                            {getBalanceIcon(balance.leave_type.name)}
                                        </div>
                                        <div>
                                        <h3 className="font-black text-slate-800 text-lg leading-tight">{balance.leave_type.name}</h3>
                                    ...
                                    <div
                                        className={`absolute top-0 left-0 h-full rounded-full transition-all duration-1000 ease-out bg-purple-500`}
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm font-black text-slate-800">{balance.used_days} / {balance.total_days}</span>
                                    </div>
